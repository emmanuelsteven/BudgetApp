...
**BudgetApp** This is a mobile first web application solution for tracking your expenses and their amounts all neatly packed together in one package. Intuitive design, functionality and User experience are the core fundamentals with this rails application. 
...
```sh  
   git clone https://github.com/emmanuelsteven/BudgetApp.git
   cd BudgetApp
```
...
Feel free to check the [issues page](https://github.com/emmanuelsteven/BudgetApp/issues).
